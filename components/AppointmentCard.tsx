            ...
            <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: "#F1F1F1" }} >
                ...
                <View style={{ marginLeft: 24, display: 'flex', width: width - 236 }} >
                    ...
                    <View style={{ marginTop: 6, display: 'flex', flexDirection: 'row', alignItems: 'center' }} >
                        <Icon iconType='calendarIcon' height='16' width='16' />
            ...
            <View style={{ marginTop: 16 }} >
                    {appointment?.status === AppointmentStatus.PENDING &&
                        <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }} >
                            <CustomButton iconType="crossTickIcon" width='HALF' title="Deny" onPress={() => handleStatusUpdate && handleStatusUpdate("CANCEL", appointment?._id)} textColor="#009688" containerStyle={{ backgroundColor: "#fff", borderWidth: 1, borderColor: "#009688" }} />
                            <CustomButton iconType="rightTickIcon" width='HALF' title="Approve" onPress={() => handleStatusUpdate && handleStatusUpdate("ACCEPT", appointment?._id)} />
                        </View>
                    }
            </View>
        </View>
